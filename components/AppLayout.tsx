  ...
  return (
    <div className='h-full w-full bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526] relative'>
      ...
      <div className='fixed top-0 left-0 right-0 w-full flex justify-between items-center p-4 z-20'>
        ...
        <Button className='cursor-pointer px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-700 rounded shadow text-white font-semibold hover:from-cyan-400 hover:to-blue-600 transition drop-shadow-glow'>
